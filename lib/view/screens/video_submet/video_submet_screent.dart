...
class VideoSubmetScreen extends StatefulWidget {
  ...
  String assignmentFileUrl;
   VideoSubmetScreen({super.key,required this.lessonId,required this.assignmentFileUrl,required this.courseId});
            ...
            MyOutLineButton(
              onClick: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => AddWorkScreen(lessonId: widget.lessonId,courseId: widget.courseId),
                ));
              },
              width: width * 0.7,
              height: height * 0.065,
